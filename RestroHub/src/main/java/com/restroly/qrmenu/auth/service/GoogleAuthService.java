...
//                    UserRoleRestaurant userRoleRestaurant = new UserRoleRestaurant();
//                    userRoleRestaurant.builder().role(customerRole)
//                            .user(newUser)
//                            .restaurant(restaurantService.getRestaurantByNameEntity(registerRequest.getRestaurantName()));
//                    newUser.getUserRoleRestaurants().add(userRoleRestaurant)
//
