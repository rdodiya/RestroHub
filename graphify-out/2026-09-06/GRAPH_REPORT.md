# Graph Report - RestroHub  (2026-09-06)

## Corpus Check
- 335 files · ~155,189 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2360 nodes · 6076 edges · 133 communities (110 shown, 23 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 406 edges (avg confidence: 0.8)
...
Cohesion: 0.12
Nodes (30): com.fasterxml.jackson.annotation.JsonInclude, lombok.AllArgsConstructor, lombok.Builder, lombok.Data, lombok.NoArgsConstructor, ForgotPasswordRequest, ResetPasswordRequest, VerifyResetCodeRequest (+22 more)

### Community 2 - "AuthServiceImpl"
Cohesion: 0.15
Nodes (8): org.springframework.http.HttpStatus, org.springframework.mail.javamail.JavaMailSender, AuthServiceImpl, Override, BusinessException, EmailService, EmailServiceImpl, Override

### Community 3 - "SecurityConfig.java"
Cohesion: 0.07
Nodes (33): io.swagger.v3.oas.annotations.security.SecurityScheme, io.swagger.v3.oas.models.OpenAPI, jakarta.validation.Validator, jakarta.validation.ValidatorFactory, OpenAPI, org.junit.jupiter.api.AfterAll, org.junit.jupiter.api.BeforeAll, org.junit.jupiter.params.ParameterizedTest (+25 more)
...
Cohesion: 0.15
Nodes (11): org.springframework.web.bind.annotation.CrossOrigin, org.springframework.web.bind.annotation.DeleteMapping, org.springframework.web.bind.annotation.GetMapping, org.springframework.web.bind.annotation.PutMapping, org.springframework.web.bind.annotation.RequestMapping, org.springframework.web.bind.annotation.RestController, HomeController, BranchService (+3 more)

### Community 6 - "RestaurantUpdateDTO"
Cohesion: 0.15
Nodes (8): BeanMapping, GenericMapper, AllArgsConstructor, Builder, Data, NoArgsConstructor, RestaurantUpdateDTO, RestaurantMapper

### Community 7 - "RestaurantResponseDTO"
Cohesion: 0.14
Nodes (11): PostMapping, AllArgsConstructor, Builder, Data, NoArgsConstructor, RestaurantRequestDTO, AllArgsConstructor, Builder (+3 more)

### Community 8 - "org.springframework.http.ResponseEntity"
Cohesion: 0.07
Nodes (33): io.swagger.v3.oas.annotations.Operation, org.springframework.http.ResponseEntity, org.springframework.security.access.prepost.PreAuthorize, PostMapping, PutMapping, PostMapping, PutMapping, DeleteMapping (+25 more)

### Community 9 - "Order"
Cohesion: 0.10
Nodes (16): AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, PrePersist, Setter, Table (+8 more)

### Community 10 - "JwtTokenProvider"
Cohesion: 0.09
Nodes (17): jakarta.annotation.PostConstruct, jakarta.servlet.FilterChain, jakarta.servlet.http.HttpServletResponse, javax.crypto.SecretKey, org.springframework.security.core.Authentication, org.springframework.security.core.userdetails.UserDetails, org.springframework.security.core.userdetails.UserDetailsService, org.springframework.web.filter.OncePerRequestFilter (+9 more)

### Community 11 - "Food"
Cohesion: 0.07
Nodes (23): org.hibernate.annotations.SQLDelete, org.hibernate.annotations.SQLRestriction, CategoryDTO, Category, AllArgsConstructor, Builder, Entity, Getter (+15 more)
...
Cohesion: 0.10
Nodes (30): io.swagger.v3.oas.annotations.tags.Tag, lombok.extern.slf4j.Slf4j, lombok.RequiredArgsConstructor, org.springframework.messaging.simp.SimpMessagingTemplate, org.springframework.validation.annotation.Validated, ApiConstants, FoodController, RequestMapping (+22 more)

### Community 19 - "FoodServiceImpl"
Cohesion: 0.14
Nodes (10): org.springframework.cache.annotation.Cacheable, org.springframework.cache.annotation.CacheEvict, FoodMapper, FoodUpdateDTO, AllArgsConstructor, Builder, Data, NoArgsConstructor (+2 more)

### Community 20 - "Profile.jsx"
Cohesion: 0.10
Nodes (20): Header(), TODO: Replace hardcoded branchId with actual branch from auth context, formatGender(), getNames(), PersonalInfoCard(), ProfileHeader(), ProfileImageModal(), ProfileSidebar() (+12 more)
...
Cohesion: 0.07
Nodes (26): org.mapstruct.Mapper, AllArgsConstructor, Builder, Data, NoArgsConstructor, ServiceRequestDTO, AllArgsConstructor, Builder (+18 more)

### Community 23 - "org.springframework.transaction.annotation.Transactional"
Cohesion: 0.14
Nodes (5): org.springframework.transaction.annotation.Transactional, UserResponse, UserService, Override, UserServiceImpl
...
Cohesion: 0.16
Nodes (4): RoleResponse, RoleService, Override, RoleServiceImpl
...
### Community 31 - "MenuService"
Cohesion: 0.11
Nodes (5): DeleteMapping, GetMapping, PatchMapping, ResponseStatus, MenuService

### Community 32 - "CustomUserDetailsService.java"
Cohesion: 0.23
Nodes (6): org.springframework.security.authentication.DisabledException, org.springframework.security.authentication.LockedException, CustomUserDetailsService, Override, UserDisabledException, UserLockedException
...
### Community 35 - "BranchServiceImpl"
Cohesion: 0.14
Nodes (4): BranchMapper, MenuDTO, BranchServiceImpl, Override

### Community 36 - "User"
Cohesion: 0.09
Nodes (11): AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, PrePersist, PreUpdate, Setter (+3 more)

### Community 39 - "PageResponseDTO"
Cohesion: 0.11
Nodes (12): org.springframework.web.multipart.MultipartFile, PageResponseDTO, GetMapping, PatchMapping, PostMapping, PutMapping, FoodResponseDTO, AllArgsConstructor (+4 more)

### Community 40 - "org.springframework.stereotype.Service"
Cohesion: 0.09
Nodes (17): org.springframework.security.authentication.AuthenticationManager, org.springframework.security.crypto.password.PasswordEncoder, org.springframework.stereotype.Service, org.springframework.web.bind.annotation.ResponseStatus, DashboardServiceImpl, DuplicateResourceException, RoleNotFoundException, UserNotFoundException (+9 more)
...
### Community 42 - "Role"
Cohesion: 0.14
Nodes (14): org.slf4j.Logger, org.springframework.boot.ApplicationArguments, org.springframework.boot.ApplicationRunner, AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor (+6 more)
...
Cohesion: 0.16
Nodes (6): AdminSkeleton(), LiveOrders(), getBranchId(), QuickActions(), RevenueChart(), StatsSection()

### Community 45 - "Tables"
Cohesion: 0.12
Nodes (11): AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, PrePersist, PreUpdate, Setter (+3 more)

### Community 46 - "SubscriptionServiceImpl"
Cohesion: 0.09
Nodes (14): GetMapping, RequestMapping, RestController, RestaurantSubscriptionController, PutMapping, RestaurantSubscriptionDto, RestaurantSubscriptionRequest, SubscriptionFeatureDto (+6 more)

### Community 47 - "UpiLinkResponseDTO"
Cohesion: 0.18
Nodes (6): UpiLinkResponseDTO, UpiLink, UpiLinkRepository, UpiLinkService, Override, UpiLinkServiceImpl
...
### Community 52 - "ResourceNotFoundException"
Cohesion: 0.09
Nodes (14): ResourceNotFoundException, AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, Setter, Table (+6 more)

### Community 53 - "OrderStatus"
Cohesion: 0.10
Nodes (11): Override, OrderStatus, BILLED, CANCELLED, COMPLETED, CONFIRMED, PENDING, PREPARING (+3 more)
...
Cohesion: 0.08
Nodes (24): org.springframework.data.jpa.repository.JpaRepository, org.springframework.stereotype.Repository, PasswordResetTokenRepository, CategoryRepository, OrderItemRepository, AllArgsConstructor, Builder, Entity (+16 more)
...
### Community 62 - "PaymentVerification"
Cohesion: 0.16
Nodes (12): org.junit.jupiter.api.BeforeEach, org.junit.jupiter.api.extension.ExtendWith, PaymentStatus, CANCELLED, PENDING, SUCCESS, Entity, Table (+4 more)
...
Cohesion: 0.09
Nodes (13): io.swagger.v3.oas.annotations.responses.ApiResponses, BranchController, DeleteMapping, GetMapping, PatchMapping, RequestMapping, ResponseStatus, RestController (+5 more)
...
### Community 84 - "TableServiceImpl"
Cohesion: 0.23
Nodes (3): ResourceAlreadyExistsException, Override, TableServiceImpl
...
Cohesion: 0.16
Nodes (10): AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, Setter, Table, SiteConfig (+2 more)
...
### Community 92 - "RestaurantServiceImpl"
Cohesion: 0.30
Nodes (3): Override, RequiredArgsConstructor, RestaurantServiceImpl

### Community 93 - "✨ Features"
Cohesion: 0.40
Nodes (5): 🚀 Advanced Features (In Development), 📱 Core Features, ✅ Feature Checklist, ✨ Features, 🗺️ Roadmap

### Community 94 - "PaymentService"
Cohesion: 0.29
Nodes (3): jakarta.transaction.Transactional, org.springframework.core.io.Resource, PaymentService

### Community 96 - "Branch.java"
Cohesion: 0.21
Nodes (8): jakarta.persistence.Entity, jakarta.persistence.PrePersist, jakarta.persistence.PreUpdate, jakarta.persistence.Table, lombok.Getter, lombok.Setter, RegisterRequest, PasswordResetToken
...
### Community 117 - "RestaurantRepository"
Cohesion: 0.43
Nodes (5): org.springframework.boot.CommandLineRunner, org.springframework.jdbc.core.JdbcTemplate, DatabaseInitializer, Override, RestaurantRepository

### Community 127 - "io.swagger.v3.oas.annotations.media.Schema"
Cohesion: 0.11
Nodes (12): io.swagger.v3.oas.annotations.media.Schema, GoogleAuthRequest, AllArgsConstructor, Builder, Data, NoArgsConstructor, LoginRequest, CategoryRequestDTO (+4 more)
...
- **Why does `Branch` connect `Branch` to `lombok.Builder`, `org.junit.jupiter.api.Test`, `org.springframework.http.ResponseEntity`, `Order`, `Food`, `MenuDTO`, `CreateOrderRequest`, `OrderItem`, `Address`, `Restaurant`, `BranchServiceImpl`, `org.springframework.stereotype.Service`, `Tables`, `UpiLinkResponseDTO`, `ResourceNotFoundException`, `OrderStatus`, `org.springframework.data.domain.Pageable`, `Branch.java`, `io.swagger.v3.oas.annotations.media.Schema`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `Restaurant` connect `Restaurant` to `Branch.java`, `lombok.Builder`, `AuthServiceImpl`, `BranchServiceImpl`, `User`, `RestaurantUpdateDTO`, `RestaurantResponseDTO`, `org.springframework.stereotype.Service`, `org.springframework.http.ResponseEntity`, `RestaurantRepository`, `org.springframework.data.domain.Pageable`, `ServiceRequestResponseDTO`, `Branch`, `org.springframework.data.jpa.repository.JpaRepository`, `RestaurantServiceImpl`, `RestaurantSubscription`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `Profile.jsx`, `ThemeSelector.jsx`, `Menus.jsx`, `Login.jsx`, `Register.jsx`, `AdminSkeleton.jsx`, `routes/index.jsx`, `Tables.jsx`, `package.json`, `Orders.jsx`, `QRDisplay.jsx`, `UPILinks.jsx`, `App.jsx`, `Branches.jsx`, `ContactSection.jsx`, `ForgotPassword.jsx`, `auth.js`, `MenusGrid.jsx`, `UserRoleManagement.jsx`, `useWebSocketNotifications.js`?**
...
- **Should `lombok.Builder` be split into smaller, more focused modules?**
  _Cohesion score 0.12030755314337403 - nodes in this community are weakly interconnected._
